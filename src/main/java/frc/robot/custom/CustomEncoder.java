...
public class CustomEncoder{
    ...
    public static double mapTickToAngle(double startTick, double endTick, double startAngle, double endAngle, boolean tickToAngle){
        double result;

        double tickDiff = endTick - startTick;
        double angleDiff = endAngle - startAngle;
        
        double tickAngle = angleDiff / tickDiff;
        double angleTick = tickDiff / angleDiff;
    ...
    public static double convertAngleToTick(double angleByTick, double desiredAngle){
        return desiredAngle / angleByTick;
    }
