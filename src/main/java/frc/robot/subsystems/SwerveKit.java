...
public class SwerveKit {

  private final CANSparkMax m_drivingSparkFlex;
   ...
   * Encoder.
   */
  public SwerveKit(int drivingCANId, int turningCANId, double chassisAngularOffset) {
    m_drivingSparkFlex = new CANSparkMax(drivingCANId, MotorType.kBrushless);
