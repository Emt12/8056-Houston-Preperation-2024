...
public final class Constants {
  ...
  public static final class CanIds{
    ...
    //intake
    public static final int kRollerCanId            = 41;
    //index
    public static final int kIndexLeftCanId         = 42;
    public static final int kIndexRightCanId        = 46;
    //shooter
    public static final int kWristCanId             = 43;

    public static final int kShooterLeft            = 44;
    public static final int kShooterRight           = 45;
  ...
  public static final class ModuleConstants {
    ...
    public static final int kDrivingMotorPinionTeeth = 12;//high torque
  ...
  public static final class OIConstants {
    ...
    public static final int kTestController = 2;

    public static final double kDriveDeadband = 0.05;
    public static final double kWristDeadband = 0.005;
  }
  ...
  public static final class NeoMotorConstants {
    public static final double kFreeSpeedRpm = 5400;//for neo v1.1 max 5676 rpm
  }
  ...
  public static final class IntakeConstants {
    public static final int MZ80Port = 9;
  }
